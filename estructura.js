...
// metodo de orden superior para control de stock
const controlStock = detalleStock.filter((articulo) => articulo.stock < 10);
    console.table(controlStock);
    console.log('Reponer Mercaderia!!!');

// metodo map para evaluar posible innovacion de articulos
const evaluacion = detalleStock.map((articulo) => {
    return {
...
console.table(evaluacion);
console.log ('Si los colores son iguales Buscar proveedores por nuevos colores!!!!!')
